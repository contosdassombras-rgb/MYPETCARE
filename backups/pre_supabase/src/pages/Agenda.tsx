...
import { Calendar as CalendarIcon, Clock, CheckCircle2, Circle, Plus, X, Trash2, Syringe, Pill, Stethoscope, Heart } from 'lucide-react';
...
export const Agenda: React.FC = () => {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    if (editingEvent) {
      updateEvent(editingEvent.petId, editingEvent.event.id, newEvent);
      setEditingEvent(null);
    } else {
      addEvent(selectedPetId, newEvent);
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center gap-3 ml-4">
                    <button
                      onClick={() => updateEvent(event.petId, event.id, { completed: !event.completed })}
                      className={cn(
                    ...
                    <button
                      onClick={() => deleteEvent(event.petId, event.id)}
