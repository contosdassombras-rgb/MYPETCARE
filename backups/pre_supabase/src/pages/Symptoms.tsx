...
2. Use cautious language like "May be related to..." or "Veterinary evaluation is recommended."
3. List possible causes (3-5 items maximum).
4. Determine urgency level: Low, Medium, High, or Emergency.
5. Provide a clear, actionable recommendation.
6. Respond ENTIRELY in ${langMap[language as string] || 'English'}.
7. Return ONLY a valid JSON object with these keys:
